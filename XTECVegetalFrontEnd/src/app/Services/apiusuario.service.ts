...
export class ApiusuarioService {
  ...
  url: string = "https://localhost:5000/api/Usuario";
  urlEstudiante: string = "http://localhost:5000/api/estudiantes";
  urlProfesor: string = "http://localhost:5000/api/profesores";
